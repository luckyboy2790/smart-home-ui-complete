...
const FooterContainer = () => {
  ...
  return (
    <div className="relative md:h-25 row-start-3 col-span-full z-2 w-full flex justify-center items-center">
      <div className="absolute md:top-0 -top-5 md:h-17 h-14 flex flex-col items-center z-10 max-w-3/5 rounded-[10000px] overflow-hidden justify-center backdrop-blur bg-[#2e2e2ea8] shadow-sm shadow-gray-400">
        <div
          ref={scrollRef}
          className="w-full flex gap-3 overflow-x-scroll rounded-full p-2"
          onMouseDown={(e) => startDrag(e.clientX)}
          onMouseMove={(e) =>
            dragStartedRef.current && updateDrag(e.clientX - startXRef.current)
          }
          onMouseUp={endDrag}
          ...
          onTouchMove={(e) =>
            ...
            updateDrag(e.touches[0].clientX - startXRef.current)
          }
          onTouchEnd={endDrag}
