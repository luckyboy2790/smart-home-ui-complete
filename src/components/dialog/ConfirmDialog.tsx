...
export default function ConfirmDialog({ isOpen, options, onClose }: ConfirmDialogProps) {
    useEffect(() => {
                ...
                >
                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4">
                        <motion.div
                            ...
                            className="bg-gray-950 text-white w-full max-w-md p-6 rounded-xl shadow-2xl border border-green-500"
                            role="document"
                        ...
                        >
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <h2
                                    ...
                                    className="text-xl font-bold text-[#00ff80] neon-text"
                                >
                                    {title}
                                </h2>
                            </div>
                            <p id="confirm-dialog-description" className="mt-2 text-sm text-gray-300">
                                {description}
                            </p>
