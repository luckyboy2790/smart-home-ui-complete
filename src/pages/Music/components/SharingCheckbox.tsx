  ...
  return (
    <StyledWrapper>
      <div className="checkbox-container">
        <h3 className="text-base text-white">share</h3>
        <div className="checkbox-wrapper">
          ...
          />
          <label htmlFor={`checkbox-${groupName}`} className="checkbox-label">
...
export default SharingCheckbox;
