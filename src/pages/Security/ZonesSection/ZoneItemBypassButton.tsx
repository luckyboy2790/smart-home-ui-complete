const ZoneItemBypassButton = ({ onClick }: { onClick: () => void }) => {
  return (
    <button
      onClick={onClick}
      className="relative px-8 py-2 bg-black text-white font-semibold rounded-lg border-2 border-emerald-500 hover:border-emerald-400 transition-all duration-300 hover:shadow-[0_0_20px_10px_rgba(85,247,127,0.4)] active:scale-95 active:shadow-[0_0_10px_5px_rgba(85,247,127,0.4)] group"
    >
