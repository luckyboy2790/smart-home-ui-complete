...
const TVControlsKeyboards = () => {
  ...
  return (
    <div className="group relative flex flex-col h-full rounded-xl bg-slate-950 p-4 shadow-2xl transition-all duration-300 hover:scale-[1.02] hover:shadow-indigo-500/20">
